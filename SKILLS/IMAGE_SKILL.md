---
name: image
description: "When the user wants to create, generate, edit, or optimize images for marketing — blog heroes, social graphics, product mockups, profile banners, promotional wallpapers, listing visuals, or brand assets. Also use when the user mentions 'AI image generation,' 'generate an image,' 'create a graphic,' 'product mockup,' 'hero image,' 'social media graphic,' 'banner image,' 'cover photo,' 'profile banner,' 'promotional wallpaper,' 'fondo de pantalla,' 'listing screenshot,' 'Flux,' 'Midjourney,' 'DALL-E,' 'GPT Image,' 'Ideogram,' 'Gemini image,' 'Canva,' 'Figma,' 'image optimization,' 'compress images,' 'WebP,' or 'OG image.' Use this for general-purpose marketing image creation and optimization. For paid ad image creative and platform-specific ad specs, see ad-creative. For video production, see video."
metadata:
  version: 1.1.0
---
...
### Promotional Mobile Wallpapers (Fondo de Pantalla Promocional)

Generar una imagen vertical de alta calidad que funcione como fondo de pantalla para promocionar una página web específica.

**Objetivo:** Crear una pieza publicitaria vertical (mobile wallpaper) de alto impacto estético que dirija tráfico a una web mediante diseño y código QR.

**Entradas requeridas / opcionales:**
- URL de la página web (Obligatorio)
- Logo de la marca (Opcional)
- Manual de identidad visual / Colores (Opcional)
- Texto principal o llamada a la acción (Opcional)

**Especificaciones Técnicas & Márgenes Seguros:**
- **Resolución:** **1080 × 1920 px** (Full HD vertical)
- **Relación de Aspecto:** **9:16**
- **Formato:** PNG (alta calidad, sin compresión visible)
- **Margen seguro superior/inferior:** Mantener al menos **180 px** libres arriba y **220 px** libres abajo para evitar interferencia con el reloj, barra de estado, dock y gestos del sistema.
- **Margen seguro lateral:** Mantener al menos **60 px** de margen en los bordes izquierdo y derecho.

**Proceso de Ejecución:**
1. **Análisis de marca y web:** Estudiar la identidad visual, paleta cromática, tipografía, oferta de valor, público objetivo y mensaje clave.
2. **Composición original:** Diseñar un arte conceptual inspirado en la web sin vulnerar derechos de propiedad intelectual.
3. **Generación 9:16:** Configurar dimensiones verticales exactas con espacio negativo adecuado.
4. **Integración de elementos:** Ubicar con elegancia la identidad corporativa, texto claro/minimalista y zona limpia para íconos/widgets.
5. **Inclusión de Código QR:** Incorporar un código QR nítido y probado que dirija a la URL destino.
